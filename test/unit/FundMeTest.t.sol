...
contract FundMeTest is Test {
    ...
    function setUp() public {
        //us(msg.sender) -> FundMeTest(address(this)) -> FundMe(called contract)
    ...
    function test_priceVersion() public {
    ...
    function testWithdrawForMultipleFunders() public funded {
        ...
        for (uint160 i = startingFunderIndex; i < numberOfFunders; i++) {
            ...
            // 1&2 above can be replaced by "hoax", which gives and address and ether
